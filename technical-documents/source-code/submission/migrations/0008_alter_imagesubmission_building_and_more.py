""" Creates the class for altering the building in an image submission. """
from django.db import migrations, models


class Migration(migrations.Migration):
    """ Defines the database migration for altering
    ...
    operations = [
        migrations.AlterField(
            ...
            name='building',
            field=models.CharField(choices=[('ALEXANDER', 'Alexander'),
                                            ('AMORY', 'Amory'),
